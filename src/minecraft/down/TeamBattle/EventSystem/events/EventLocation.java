...
public void setLoctaion(double x, double y, double z, boolean onGround) {
  this.posPacket = new C03PacketPlayer.C04PacketPlayerPosition(x, y - 0.6D, z, onGround);
  this.lookPacket = new C03PacketPlayer.C06PacketPlayerPosLook(x, y - 0.6D, z, mc.thePlayer.rotationYaw, mc.thePlayer.rotationPitch, onGround);
}
}

...
public class GuiAltManager extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(login = new GuiButton(1, this.width / 2 - 154,
				this.height - 48, 100, 20, "Login"));
		this.buttonList.add(remove = new GuiButton(2, this.width / 2 - 74,
		...
		this.buttonList.add(rename = new GuiButton(6, this.width / 2 + 4,
				this.height - 24, 70, 20, "Rename"));
		this.buttonList.add(new GuiButton(7, this.width / 2 - 206,

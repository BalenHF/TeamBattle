...
public class PlayerControllerMP
{
    ...
    {
    	//TODO
    	EventBlockClicked clicked = new EventBlockClicked(this.blockHitDelay, 
    			this.blockHitDelay, this.currentPlayerItem, this.currentPlayerItem);
    ...
    {
    	//TODO
    	EventBlockBreaking event = new EventBlockBreaking(this.currentPlayerItem, 
    			this.blockHitDelay, this.currentPlayerItem, this.blockHitDelay, 5, 1.0F);
    ...
    {
    	//TODO
    	EventAttack event =new EventAttack(playerIn, targetEntity);
    	TeamBattleClient.getEventManager().call(event);
        this.syncCurrentPlayItem();

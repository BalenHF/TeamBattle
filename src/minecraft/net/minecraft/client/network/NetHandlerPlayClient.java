...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityMetadata(S1CPacketEntityMetadata packetIn)
    {
        ...
        //TODO
        EventVelocity event = new EventVelocity(EventVelocity.Type.KNOCKBACK, var2);
        /*  521 */     TeamBattleClient.getEventManager().call(event);
        /*  522 */     if (event.isCancelled()) {
        /*  523 */       return;
    ...
    {
    	//TODO
    	EventPacketSent event = new EventPacketSent(
    			/*  839 */       p_147297_1_);
    			/*  840 */     TeamBattleClient.getEventManager().call(event);
    			/*  841 */     if (event.isCancelled())
    			/*  842 */       return;

...
//TODO
    ...
    {
    	//TODO
    	 EventRightClick event = new EventRightClick(this.rightClickDelayTimer);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	EventKeyPressed event = new EventKeyPressed(
...
EventWorldLoad event = new EventWorldLoad(worldClientIn);
/* 2351 */     TeamBattleClient.getEventManager().call(event);

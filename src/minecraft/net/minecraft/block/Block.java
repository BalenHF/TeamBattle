...
//TODO
        EventBlockBoundingBox event = new EventBlockBoundingBox(var7, state.getBlock(), pos.getX(), pos.getY(), pos.getZ());
        /*  487 */     TeamBattleClient.getEventManager().call(event);
        /*  488 */     var7 = event.getBoundingBox();
    ...
    public int getRenderBlockPass() {
    	/*  496 */     EventRenderBlockPass event = new EventRenderBlockPass(this, 0);
    	/*  497 */     TeamBattleClient.getEventManager().call(event);
    	/*  498 */     return event.getRenderBlockPass();
    	/*      */   }
  ...
  //TODO
    public boolean renderAsNormalBlock() {
    	...
    	/*  593 */     EventRenderAsNormalBlock event = new EventRenderAsNormalBlock(
    	/*  594 */       true);
    	/*  595 */     TeamBattleClient.getEventManager().call(event);
    	/*  596 */     return event.shouldRenderAsNormalBlock();
    	/*      */   }
    /**
    ...
    {
    	//TODO
    	EventBlockRender blockRender = new EventBlockRender(null, this.lightOpacity, this.lightValue, this.lightOpacity);
    	/*  830 */     TeamBattleClient.getEventManager().call(blockRender);
